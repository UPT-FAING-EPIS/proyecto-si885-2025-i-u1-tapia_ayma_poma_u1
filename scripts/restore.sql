...
USING (VALUES
    ...
    (2, 'Universidad Nacional de San Agust�n de Arequipa', 'Arequipa', 'PRIVADA'),
    (3, 'Universidad C�sar Vallejo', 'Lima', 'PUBLICA'),
    ...
    (8, 'Pontificia Universidad Cat�lica del Per�', 'Lima', 'PRIVADA'),
    (9, 'Universidad Privada del Norte', 'Piura', 'PRIVADA'),
    (10, 'Universidad de San Mart�n de Porres', 'Lima', 'PRIVADA')
...
USING (VALUES
    ...
    (2, 2023, 'Sistemas de Informaci�n', 2),
    (3, 2024, 'Inteligencia Artificial', 3),
    (4, 2023, 'An�lisis de Datos', 4),
    (5, 2024, 'Desarrollo de Aplicaciones Web', 5),
    (6, 2023, 'Aplicaciones M�viles', 6),
    (7, 2024, 'Seguridad Inform�tica', 7),
    (8, 2023, 'Internet de las Cosas (IoT)', 8),
    (9, 2024, 'Big Data y Cloud Computing', 5),
    (10, 2023, 'Desarrollo de Videojuegos', 10)
) AS source ([id_tesis], [a�o_publicacion], [categoria], [id_universidad])
ON target.[id_tesis] = source.[id_tesis]
WHEN NOT MATCHED THEN
    INSERT ([id_tesis], [a�o_publicacion], [categoria], [id_universidad]) VALUES (source.[id_tesis], source.[a�o_publicacion], source.[categoria], source.[id_universidad]);
GO
